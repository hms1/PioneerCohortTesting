...
#
# This file is part of PioneerTestCohorts
#
...
getCohortGroups <- function() {
  pathToCsv <- system.file("settings", "CohortGroups.csv", package = "PioneerTestCohorts")
...
execute <- function(connectionDetails,
  ...
  if (createCohorts) {
    for (i in 1:nrow(cohortGroups)) {
      ...
      CohortDiagnostics::instantiateCohortSet(connectionDetails = connectionDetails,
                                              ...
                                              packageName = "PioneerTestCohorts",
  ...
  if (runCohortDiagnostics) {
    for (i in 1:nrow(cohortGroups)) {
      ...
      CohortDiagnostics::runCohortDiagnostics(packageName = "PioneerTestCohorts",
                                              cohortToCreateFile = cohortGroups$fileName[i],
