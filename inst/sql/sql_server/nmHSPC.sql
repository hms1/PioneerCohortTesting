...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (21603834,21603823,21603845)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (21603834,21603823,21603845)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45768763,4134732)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (45768763,4134732)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40239056,1315942,42900250,40224095,1551099,43526934,35603551)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40239056,1315942,42900250,40224095,1551099,43526934,35603551)
  and c.invalid_reason is null
...
where ce.condition_concept_id in (SELECT concept_id from  #Codesets where codeset_id = 4)
) C
